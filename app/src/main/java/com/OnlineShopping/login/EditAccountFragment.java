...
public class EditAccountFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_edit_account, container, false);
    ...
    public void onClick(View view) {
        ...
        if(!validateUserName() | !validateEmail() | !validatePassword())
        {
            ...
            boolean isUpdated = db.update(name.getText().toString(), address.getText().toString(), contact.getText().toString(), userName.getText().toString(), email.getText().toString(), password.getText().toString());
